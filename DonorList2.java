...
class DonorList2 extends JFrame implements ActionListener{
...
//connect  app to mysql database
	try{
		...
		s = "SELECT `Name`,`Address`,`Email`,`Contact No.`,`Gender`,`Donate Blood Group`,`Last Donate Date`FROM `donor_list`";
